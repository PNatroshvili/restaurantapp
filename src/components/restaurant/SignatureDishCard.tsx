...
const styles = StyleSheet.create({
  ...
  imageWrapper: { width: '100%', height: 90 },
  dishImage: { width: '100%', height: 90, resizeMode: 'cover' },
  touristBadge: {
    position: 'absolute',
    bottom: 6,
    left: SPACING.sm,
  ...
  touristText: { fontSize: 9, fontWeight: '700', color: '#fff' },
  name: { fontSize: 15, fontWeight: '900', color: '#fff', textAlign: 'center', paddingHorizontal: SPACING.sm, marginTop: SPACING.sm },
  latin: { fontSize: 10, color: '#aaa', fontWeight: '500', marginTop: 2, textAlign: 'center', paddingHorizontal: SPACING.sm },
  ...
  votes: { fontSize: 9, color: '#888', marginTop: 3 },
});
